...
var light = new vec3.fromValues(2, 4, -0.5);
...
function handleKeys(){
    if(currentlyPressedKeys[65]){//a
        ...
        //mat4.translate(mvMatrix, mvMatrix, new vec3.fromValues(0.01,0,0));
    }
    ...
    if(currentlyPressedKeys[81]){//q
        vec3.add(eye, eye, new vec3.fromValues(0,0.01,0));
        vec3.add(lookAt, lookAt, new vec3.fromValues(0,0.01,0));
    }
    ...
    if(currentlyPressedKeys[87]){//w
        vec3.add(eye, eye, new vec3.fromValues(0,0,0.01));
    }
    ...
    if(currentlyPressedKeys[16] && currentlyPressedKeys[81]){//Q
        ...
        //mat4.rotateZ(mvMatrix, mvMatrix, 0.02);
    }
