...
const INPUT_TRIANGLES_URL = "https://ncsucgclass.github.io/Prog 2/inputFiles/triangles.json"; // triangles file loc
...
function loadSpheres(){
    ...
    if(inputSpheres != String.null){
        ...
        for(var whichSet =4; whichSet<inputSpheres.length;whichSet++){
            var center = [];
